...
// V4 init  → Subgraph totalValueLockedToken0/1  exact TVL
// V4 swap  → delta amount0/amount1 from event   real-time tracking
// V4 modLiq→ re-sync from subgraph after 60s    reconcile LP changes
// ============================================================
